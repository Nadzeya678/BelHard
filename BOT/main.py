...
# Запросить выбор пользователя через бот
...
# Получить курсы валют на сегодня
...
# А это я хотела еще конвертировать, но не понимаю, как ввод пользователя сделать переменной и цифрой
...
# Вывод курсов основных валют после окончания торгов
t = datetime.time(datetime.now())
def time_before(time):
    if t == ('14:00:00:000000'):
        return rate_list['EUR', 'USD', "RUB", 'CNY']
    else:
        return None
